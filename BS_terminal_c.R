...
################# time-varying  theta ####################
  ...
  #dyn.load("/storage/work/m/mjl6416/jointmodeling/01code/copula_dep.so") ##load c function##
  #dyn.load("/Users/mengluliang/Dropbox/biostatisitcs_PSU/RA/2020Spring/BayesianJointModel/01code/copula_dep.so")
  ...
  #dyn.load("/storage/work/m/mjl6416/jointmodeling/01code/copula_dep.so")
     ...
     ### time-varying model prediction ####
        ...
        for(m in slice){
          ...
          for(un_i in 2:10){
           ...
           tmp= .C("metroplis_phi_id",result$b1[m], result$b2[m], result$b3[m], result$b4[m], result$b01[m], result$b02[m],
        ...
        #dyn.load("/storage/work/m/mjl6416/jointmodeling/01code/copula_joint_model.so")
        dyn.load("/Users/mengluliang/Dropbox/biostatisitcs_PSU/RA/2020Spring/BayesianJointModel/01code/copula_joint_model.so") ##load c function##
        ...
        for(m in slice){
          ...
          #####MCMC begin######
          for(un_i in 2:10){
            tmp= .C("metroplis_phi_id",phiN_est_list$b1[m], phiN_est_list$b2[m], phiN_est_list$b3[m], phiN_est_list$b4[m], phiN_est_list$b01[m], phiN_est_list$b02[m],
...
saveRDS(result,paste0("400_c",idx,".rds"))
